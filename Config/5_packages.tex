...
% --- Pacotes extra para código fonte ---
\usepackage{listings}
\usepackage{xcolor}
...
\usepackage{algorithm}      % Define o ambiente "algorithm" (float)
\usepackage{algpseudocode}  % Fornece "algorithmic" estilo algpseudocode

\usepackage{glossaries}    % To create glossaries and lists of acronyms
