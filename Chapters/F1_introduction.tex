...
\begin{itemize}
    ...
    \item Desenvolver o algoritmo de sincronização hierárquico, que organiza os veículos em múltiplas camadas (como \textit{lanes} e \textit{pivots}), reduzindo redundâncias e otimizando a disseminação.
