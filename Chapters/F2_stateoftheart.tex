...
Começando tambem com o vetor de estado final representado na figura \ref{SVCP}, podemos também comprovar que realmente a troca de dados está a acontecer de forma correta, pois a versão final corresponde novamente à mais recente.
\begin{figure}[h]
    \centering
...
Na figura \ref{provedor} podemos ver quem foi o provedor dos dados mais recentes, e também a comprovar a existência de um pivô por cada faixa, que irá ser o ponto fulcral da diferença esperada entre as 2 soluções.
\begin{figure}[h]
    \centering
