...
As \gls{VANETs} apresentam características únicas, tais como uma topología altamente dinâmica devido à elevada movimentação dos nós, conectividade intermitente e enlaces de curta duração, requesitos de comunicação muito sensíveis ao tempo principalmente nas aplicações de segurança sendo que apesar de tudo os veíclos estão cada vez mais equipados com mais altas capacidades de processamento e armazenamento. Estas particularidades, aliadas ao elevado custo, e falta de infraestrutura, tornam o desenvolvimento e implementação de protocolos de comunicação para \gls{VANETs} um desafio muito grande. Levantam-se também outro tipo de problemas tais como, a segurança e privacidade, pois ataques a redes VANETs podem ter consequências catastróficas. Para as \gls{VANETs} existem 3 grandes tipo de aplicações as aplicações de segurança, de tráfego e de conforto, como vemos na Figura \ref{fig:apps}
